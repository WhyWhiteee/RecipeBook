...
const isEdit = computed(() => route.name === 'ingredients-edit')
...
async function submit() {
  ...
  try {
    ...
    toast.push(isEdit.value ? 'Ингредиент обновлён' : 'Ингредиент создан', 'success')
...
<template>
  <div class="mx-auto" style="max-width: 480px">
    <h1 class="h4 mb-4">{{ isEdit ? 'Редактирование ингредиента' : 'Новый ингредиент' }}</h1>
